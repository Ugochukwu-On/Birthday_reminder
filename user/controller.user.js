...
try{
    const currUrl = "https://wisher-styt.onrender.com"
    ...
    req.flash("messageKey", "Successful signup.")
...
const verifyEmailLink = async (req,res)=>{
    try{
      ...
      if(userToVerify.expiresAt < Date.now()){
        ...
        res.redirect(`/successfulVerification/${message}`)
      }
...
module.exports = {createUser, verifyEmailLink}